...
public class IpLocation {
    private  static String ipDataPath = "classpath:data/ip_location.dat";
    ...
    private void initIpLocation() {
        ...
        //log.info("ip location init,file path1:" + filePath);
        File file = ResourceUtils.getFile(ipDataPath);
