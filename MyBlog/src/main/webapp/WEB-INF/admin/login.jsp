...
<div class="container">
    ...
    <form class="form-signin" action="/sang/dologin" method="post">
        ...
        <input type="text" id="inputEmail" name="username" value="123" class="form-control" placeholder="用户名" required
               autofocus>
        <label for="inputPassword" class="sr-only">密码</label>
        <input type="password" id="inputPassword" value="123" name="password" class="form-control" placeholder="密码"
               required>
        <div class="checkbox">
            <label>
